	...
	properties: [
		...
		},
		{
			...
			options: [
				...
				{
					displayName: 'List Unsubscribe Post',
					name: 'listUnsubscribePost',
					type: 'string',
					default: '',
					description: 'List-Unsubscribe=One-Click',
				},
			],
		},
	],
...
export class EmailCustomV1 implements INodeType {
